...
public class ApiController {
	...
	public User saveUser(@RequestBody User user) {
		System.out.println(user.getRoles().toString() +"bbbbbbbbbbbbbbbbbbbb");
...
//	@PreAuthorize("hasRole('USER') or hasRole('MODERATOR') or hasRole('ADMIN')")
//	public Role updateCustomer(@RequestBody Role role, @PathVariable Long id) {
...
//	@PostMapping("/u")
//	@PreAuthorize("hasRole('USER') or hasRole('MODERATOR') or hasRole('ADMIN')")
//	public User updateItem(@RequestBody Item item, @PathVariable Long id) {
//		return itemService.updateItemById( id, item );
//	}
	// +++++++++++++++++++++++++++++++++++++
